...
TOOLS = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Если названо ИМЯ человека («Софии», «Ване») — assignee=это имя, "
                "даже если в тексте есть название проекта/бренда (ПВС, Озон). "
                ...
                "properties": {
                    ...
                    "assignee": {
                        ...
                        "description": (
                            ...
                            "Имя важнее проекта. all — ТОЛЬКО если сказали всем/всех "
...
async def parse_intent(
    ...
    *,
    ...
    system = (
        ...
        "«поставь задачу Софии … бренд ПВС» → assignee=София (имя!), "
        "ПВС в title оставить как часть задачи, НЕ назначать всей группе ПВС.\n"
